    ...
    <UserStyle>
      ...
      <se:FeatureTypeStyle>
        ...
        <se:Rule>
          ...
          <!--Parser Error: 
syntax error, unexpected ')', expecting $end - Expression was: "KAIDEKKE" = 'betong' AND  "VEKTBEGRENSNING" is null or "VEKTBEGRENSNING" IN ('0','9999','-9999'))-->
          <se:MinScaleDenominator>0</se:MinScaleDenominator>
          <se:MaxScaleDenominator>10000</se:MaxScaleDenominator>
          <se:PolygonSymbolizer>
            <se:Fill>
        ...
        <se:Rule>
          ...
          <!--Parser Error: 
syntax error, unexpected ')', expecting $end - Expression was: "KAIDEKKE" = 'steinHeller' AND  "VEKTBEGRENSNING" is null or "VEKTBEGRENSNING" IN ('0','9999','-9999'))-->
          <se:MinScaleDenominator>0</se:MinScaleDenominator>
          <se:MaxScaleDenominator>10000</se:MaxScaleDenominator>
          <se:PolygonSymbolizer>
            <se:Fill>
        ...
        <se:Rule>
          ...
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsEqualTo>
                <ogc:PropertyName>KAIDEKKE</ogc:PropertyName>
                <ogc:Literal>steinHeller</ogc:Literal>
              </ogc:PropertyIsEqualTo>
              <ogc:And>
                <ogc:PropertyIsGreaterThan>
                  <ogc:PropertyName>VEKTBEGRENSNING</ogc:PropertyName>
        ...
        <se:Rule>
          ...
          <!--Parser Error: 
syntax error, unexpected ')', expecting $end - Expression was: "KAIDEKKE" = 'tredekke' AND  "VEKTBEGRENSNING" is null or "VEKTBEGRENSNING" IN ('0','9999','-9999'))-->
          <se:MinScaleDenominator>0</se:MinScaleDenominator>
          <se:MaxScaleDenominator>10000</se:MaxScaleDenominator>
          <se:PolygonSymbolizer>
            <se:Fill>
