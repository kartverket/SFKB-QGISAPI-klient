...
What's Next:
  ...
  * Customize it by editing the implementation file: ``ngis_openapi_client.py``

  * Create your own custom icon, replacing the default icon.png

  * Modify your user interface by opening NgisOpenApiClient_dialog_base.ui in Qt Designer
